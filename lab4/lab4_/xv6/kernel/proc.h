...
// number of ticks between bulk priority-boosts
#define BOOST_PERIOD_TICKS  20
// to enable MLFQ PERIODIC BOOST
#define __MLFQ_BOOST__
// low & high priority queue identifiers
#define PR_HIGH 1
#define PR_LOW  0
